...
class StoriesFile_model extends MY_BackendModel {

	public function __construct(){
		parent::__construct();
		$this->abrv = 'history_story_file_';
		$this->from = 'stories_file';
		$this->id = 'history_story_file_id';
		$this->listSelect = '*';
		$this->rowSelect = '*';
	...
	public function deleteDataList($data){
		...
		if( isset($data['history_story_id']) && $data['history_story_id'] !=''){
			$data['history_story_id'] = $this->db->escape_str($data['history_story_id']);
			$this->db->where('history_story_id', $data['history_story_id'], FALSE);
		}
