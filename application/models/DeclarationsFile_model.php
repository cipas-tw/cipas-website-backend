...
class DeclarationsFile_model extends MY_BackendModel {

	public function __construct(){
		parent::__construct();
		$this->abrv = 'declaration_file_';
		$this->from = 'declarations_file';
		$this->id = 'declaration_file_id';
		$this->listSelect = '*';
		$this->rowSelect = '*';
	...
	public function deleteDataList($data){
		...
		if( isset($data['declaration_id']) && $data['declaration_id'] !=''){
			$data['declaration_id'] = $this->db->escape_str($data['declaration_id']);
			$this->db->where('declaration_id', $data['declaration_id'], FALSE);
		}
