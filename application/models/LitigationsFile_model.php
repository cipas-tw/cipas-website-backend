...
class LitigationsFile_model extends MY_BackendModel {

	public function __construct(){
		parent::__construct();
		$this->abrv = 'litigation_file_';
		$this->from = 'litigations_file';
		$this->id = 'litigation_file_id';
		$this->listSelect = '*';
		$this->rowSelect = '*';
	...
	public function deleteDataList($data){
		...
		if( isset($data['litigation_id']) && $data['litigation_id'] !=''){
			$data['litigation_id'] = $this->db->escape_str($data['litigation_id']);
			$this->db->where('litigation_id', $data['litigation_id'], FALSE);
		}
