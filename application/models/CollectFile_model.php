...
class CollectFile_model extends MY_BackendModel {

	public function __construct(){
		parent::__construct();
		$this->abrv = 'collect_plan_file_';
		$this->from = 'collect_file';
		$this->id = 'collect_plan_file_id';
		$this->listSelect = '*';
		$this->rowSelect = '*';
	...
	public function deleteDataList($data){
		...
		if( isset($data['collect_plan_id']) && $data['collect_plan_id'] !=''){
			$data['collect_plan_id'] = $this->db->escape_str($data['collect_plan_id']);
			$this->db->where('collect_plan_id', $data['collect_plan_id'], FALSE);
		}
