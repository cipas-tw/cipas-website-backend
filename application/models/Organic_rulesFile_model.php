...
class Organic_rulesFile_model extends MY_BackendModel {

	public function __construct(){
		parent::__construct();
		$this->abrv = 'org_rules_file_';
		$this->from = 'organic_rules_file';
		$this->id = 'org_rules_file_id';
		$this->listSelect = '*';
		$this->rowSelect = '*';
	...
	public function deleteDataList($data){
		...
		if( isset($data['org_rules_id']) && $data['org_rules_id'] !=''){
			$data['org_rules_id'] = $this->db->escape_str($data['org_rules_id']);
			$this->db->where('org_rules_id', $data['org_rules_id'], FALSE);
		}
