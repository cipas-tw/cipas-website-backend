...
class Administrative_actionsNote_model extends MY_BackendModel {

	public function __construct(){
		parent::__construct();
		$this->abrv = 'adm_act_note_';
		$this->from = 'administrative_actions_note';
		$this->id = 'adm_act_note_id';
		$this->listSelect = '*';
		$this->rowSelect = '*';
	...
	public function deleteDataList($data){
		...
		if( isset($data['adm_act_id']) && $data['adm_act_id'] !=''){
			$data['adm_act_id'] = $this->db->escape_str($data['adm_act_id']);
			$this->db->where('adm_act_id', $data['adm_act_id'], FALSE);
		}
