...
class Policies extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '施政計畫';
		$this->abrv = 'policy_';
		$this->load->model('policies_model', 'models');
		$this->load->model('policiesFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('policyPath');
