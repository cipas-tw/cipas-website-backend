...
class Litigations extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '相關訴訟';
		$this->abrv = 'litigation_';
		$this->load->model('Litigations_model', 'models');
		$this->load->model('LitigationsNote_model', 'noteModels');
		$this->load->model('LitigationsFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('litigationPath');
