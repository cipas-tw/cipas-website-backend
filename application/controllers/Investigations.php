...
class Investigations extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '調查進度';
		$this->abrv = 'survey_';
		$this->load->model('Investigations_model', 'models');
		$this->load->model('InvestigationsNote_model', 'noteModels');
		...
		$this->uploadPath = $this->config->item('surveyPath');
	...
	public function index(){
		...
		$data['abrv'] = $this->abrv;
		$data['unit'] = $this->unit;
		$data['frontEndUrl'] = 'investigations';
