...
class Rewardlist extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '獎勵舉發說明';
		$this->abrv = 'reward_list_';
		$this->load->model('RewardList_model', 'models');
		$this->load->model('RewardListChapter_model', 'chapterModels');
		$this->load->model('RewardListTerms_model', 'termsModels');
	...
	public function index(){
		...
		if( $op === 'upd' ){
			...
			$updateData[$this->abrv.'id'] = $this->rewardId;
		...
		// 分頁
		$queryData[$this->abrv.'id'] = $this->rewardId;
		...
		// 取資料
		$data['result'] = $this->models->getData($this->rewardId);
	...
	public function create(){
		...
		if( $op === 'add' ){
			...
			$addData[$this->abrv.'id'] = $this->rewardId;
