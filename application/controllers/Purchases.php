...
class Purchases extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '契約採購';
		$this->abrv = 'purchase_';
		$this->load->model('purchases_model', 'models');
		$this->load->model('purchasesFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('purchasePath');
