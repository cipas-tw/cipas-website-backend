...
class Notespublish extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '記事上稿';
		$this->abrv = 'notes_publish_';
		$this->load->model('NotesPublish_model', 'models');
		$this->load->model('NotesPublishFile_model', 'fileModels');
		...
		$this->haveField = array($this->abrv.'title', $this->abrv.'content', $this->abrv.'status');

		$this->uploadFolder = $this->config->item('uploadPath');
		$this->tmpPath = $this->config->item('tmpPath');
		$this->uploadPath = $this->config->item('notesPublishPath');
	...
	public function index(){
		...
		$data['abrv'] = $this->abrv;
		$data['unit'] = $this->unit;
		$data['frontEndUrl'] = 'notespublish/detail';
