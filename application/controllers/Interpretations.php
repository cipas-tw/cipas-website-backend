...
class Interpretations extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '本會解釋';
		$this->abrv = 'rule_';
		$this->load->model('Interpretations_model', 'models');
		$this->load->model('InterpretationsFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('rulePath');
	...
	public function index(){
		...
		$data['abrv'] = $this->abrv;
		$data['unit'] = $this->unit;
		$data['frontEndUrl'] = 'interpretations';
