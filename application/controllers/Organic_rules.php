...
class Organic_rules extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '組織規程';
		$this->abrv = 'org_rules_';
		$this->load->model('organic_rules_model', 'models');
		$this->load->model('organic_rulesFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('orgRulesPath');
	...
	public function index(){
		...
		$data['abrv'] = $this->abrv;
		$data['unit'] = $this->unit;
		$data['frontEndUrl'] = 'organic_rules';
