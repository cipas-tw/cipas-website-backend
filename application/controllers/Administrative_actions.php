...
class Administrative_actions extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '行政處分';
		$this->abrv = 'adm_act_';
		$this->load->model('Administrative_actions_model', 'models');
		$this->load->model('Administrative_actionsNote_model', 'noteModels');
		...
		$this->uploadPath = $this->config->item('administrativeActPath');
	...
	public function index(){
		...
		$data['abrv'] = $this->abrv;
		$data['unit'] = $this->unit;
		$data['frontEndUrl'] = 'administrative_actions';
