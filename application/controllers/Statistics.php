...
class Statistics extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '業務統計';
		$this->abrv = 'sales_';
		$this->load->model('statistics_model', 'models');
		$this->load->model('statisticsFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('salesPath');
