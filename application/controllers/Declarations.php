...
class Declarations extends MY_BackendController {
	public function __construct(){
		parent::__construct();
		$this->unit = '已申報事項';
		$this->abrv = 'declaration_';
		$this->load->model('declarations_model', 'models');
		$this->load->model('declarationsFile_model', 'fileModels');
		...
		$this->uploadPath = $this->config->item('declarationPath');
