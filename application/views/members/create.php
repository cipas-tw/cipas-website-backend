															...
															<thead>
																...
																<tbody id="education_tbody">
																	<tr id="educationRow_1">
																		...
																		<td width="10%">
																			<a class="btn red delete" onclick="delEducationRow(1)">
															...
															<thead>
																...
																<tbody id="experience_tbody">
																	<tr id="experienceRow_1">
																		...
																		<td width="10%">
																			<a class="btn red delete" onclick="delExperienceRow(1)">
								                                                <i class="fa fa-trash"></i>
								                                                <span> 刪除 </span>
																			</a>
																		</td>
											...
											<div class="form-group">
												...
												<div class="col-md-9 mt-radio-inline">
                                                    <label class="mt-radio">
                                                        <input type="radio" name="<?php echo $abrv;?>is_leader" value="1" /> 是
                                                        <span></span>
                                                    </label>
                                                    <label class="mt-radio">
                                                        <input type="radio" name="<?php echo $abrv;?>is_leader" value="0" checked/> 否
                                                        <span></span>
                                                    </label>
