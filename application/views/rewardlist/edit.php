														...
														<table class="table table-striped table-bordered table-hover">
															<thead>
																...
																<?php foreach($resultTerms as $i=>$terms){?>
																	<input type="hidden" id="<?php echo $abrv;?>terms_id[]" name="<?php echo $abrv;?>terms_id[]" aria-required="true" value="<?php echo isset($terms[$abrv.'terms_id']) ? stripslashes($terms[$abrv.'terms_id']) : '';?>" />
																	<tr id="row_<?php echo $i+1?>">
																		<td class="form-group">
																			<textarea class="form-control" name="<?php echo $abrv;?>terms_content[]"><?php echo isset($terms[$abrv.'terms_content']) ? stripslashes($terms[$abrv.'terms_content']) : '';?></textarea>
																		</td>
																		<td>
