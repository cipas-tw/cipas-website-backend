								...
								<div class="portlet light bordered form-fit">
									...
									<div class="portlet-body form">
										...
										<input type="hidden" id="<?php echo $this->security->get_csrf_token_name()?>" name="<?php echo $this->security->get_csrf_token_name()?>" value="<?php echo $this->security->get_csrf_hash()?>" />
											...
											<input type="hidden" name="related_links_id" value="<?php echo $result[$abrv.'id']?>">
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" placeholder="請填寫連結" class="form-control" id="<?php echo $abrv;?>url" name="<?php echo $abrv;?>url" aria-required="true" value="<?php echo isset($result[$abrv.'url']) ? html_entity_decode($result[$abrv.'url']) : '';?>" />
													</div>
												</div>
												<div class="form-group">
