								...
								<div class="portlet light bordered form-fit">
									...
									<div class="portlet-body form">
										...
										<input type="hidden" id="<?php echo $this->security->get_csrf_token_name()?>" name="<?php echo $this->security->get_csrf_token_name()?>" value="<?php echo $this->security->get_csrf_hash()?>" />
											...
											<input type="hidden" name="about_id" value="<?php echo $result['about_id']; ?>">
											<div class="form-body">
												<div class="form-group">
													<label class="control-label col-md-3">執掌說明</label>
													<div class="col-md-9">
														<input type="text" placeholder="請填寫執掌說明" class="form-control" id="<?php echo $abrv;?>responsibility_descriptionl" name="<?php echo $abrv;?>responsibility_descriptionl" aria-required="true" value="<?php echo isset($result[$abrv.'responsibility_descriptionl']) ? $result[$abrv.'responsibility_descriptionl'] : '';?>" />
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">組織說明</label>
													<div class="col-md-9">
														<input type="text" placeholder="請填寫組織說明" class="form-control" id="<?php echo $abrv;?>organization_descriptionl" name="<?php echo $abrv;?>organization_descriptionl" aria-required="true" value="<?php echo isset($result[$abrv.'organization_descriptionl']) ? $result[$abrv.'organization_descriptionl'] : '';?>" />
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">上傳圖片</label>
													<div class="col-md-9">
																		...
																		<td width="100%">
																			<div class="fileinput fileinput-new" data-provides="fileinput">
					                                                            <span class="btn green btn-file">
					                                                                <span class="fileinput-new"> 請選擇圖片 </span>
					                                                                <span class="fileinput-exists"> 重選 </span>
					                                                                <input type="file" id="tmp_file" name="tmp_img_file" accept="image/*">
					                                                                <input type="hidden" name="tmp_imagename" id="tmp_filename">
                                                                					<input type="hidden" name="tmp_imageurl" id="tmp_file_url">
					                                                            </span>
					                                                            <span class="fileinput-filename"><?php echo isset($result[$abrv.'orig_name']) ? $result[$abrv.'orig_name'] : '';?></span>
					                                                        </div>
																		</td>
																	</tr>
																</tbody>
