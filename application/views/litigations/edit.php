...
<!--<![endif]-->
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
															...
															<thead>
																...
																<tbody id="note_tbody">
																	...
																	<tr id="noteRow_<?php echo $i+1?>">
																		<input type="hidden" id="<?php echo $abrv;?>note_id[]" name="<?php echo $abrv;?>note_id[]" aria-required="true" value="<?php echo isset($file[$abrv.'note_id']) ? $file[$abrv.'note_id'] : '';?>" />
																		<td>
																			<div class="form-group">
		...
		jQuery(document).ready(function() {
			<?php foreach($resultNote as $i=>$note){?>
				<?php if($i != 0){ ?>
					CKEDITOR.replace("litigation_note_content[<?=$i?>]");
				<?php }?>
			<?php }?>
		});
		</script>
