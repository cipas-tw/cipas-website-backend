										...
										<table class="table table-striped table-bordered table-hover" id="lists_sort">
											...
											<tbody>
												...
												<tr data-id="<?php echo $val[$abrv.'id'];?>">
													...
													<td><?php echo $typeList[$val[$abrv.'type']];?></td>
													<td><a href="<?php echo $val[$abrv.'url'];?>" target="_blank"><?php echo $val[$abrv.'url'];?></a></td>
													<td>
													<?php if(isset($val[$abrv.'filename']) && $val[$abrv.'filename'] !=''){?>
														<img src="/<?php echo $imagePath.$val[$abrv.'filename'];?>" width="150" />
													<?php }?>
													</td>
