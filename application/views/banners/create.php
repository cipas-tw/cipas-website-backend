...
<!--<![endif]-->
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
									...
									<div class="portlet-body form">
										...
										<form id="formPost" action="" class="formPost form-horizontal form-bordered form-row-stripped" method="post">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" placeholder="請填寫連結" class="form-control" id="<?php echo $abrv;?>url" name="<?php echo $abrv;?>url" aria-required="true" value="" />
												</div>
											</div>
		...
		<form id="fileForm" action="/AjaxUpload/uploadFile" method="post" enctype="multipart/form-data" style="display: none">
		</form>
