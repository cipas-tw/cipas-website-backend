					...
					<div class="page-content">
						...
						<div class="page-bar">
							<ul class="page-breadcrumb">
								...
								<li>
									<a href="/ubmsys/<?php echo $controllerName;?>"><?php echo $unit;?>-列表</a>
									<i class="fa fa-circle"></i>
								</li>
								<li>
										...
										<div class="portlet-body form">
											<div class="form-body form-horizontal form-bordered form-row-stripped">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" placeholder="請填寫權限名稱" class="form-control" id="<?php echo $abrv;?>name" name="<?php echo $abrv;?>name" aria-required="true" value="<?php echo isset($result[$abrv.'name']) ? stripslashes($result[$abrv.'name']) : '';?>" />
													</div>
												</div>
											</div>
										</div>
											...
											<?php foreach($sidebarList as $val){?>
												<div class="form-group">
																...
																<div class="col-md-9">
																	<?php foreach($sidebarPermissionType as $k=>$type){?>
																		<label class="mt-checkbox">
																			<input type="checkbox" class="backend_menu_permission<?php echo $k;?>" name="<?php echo $abrv;?>lists[]" value="<?php echo $v['backend_menu_id'],$k;?>" <?php echo strstr($result['backend_menu_permission_lists'], ','.$v['backend_menu_id'].$k.',') ? 'checked' : '';?>><?php echo $type;?><span></span>
																		</label>
																	<?php }?>
																</div>
															</div>
													...
													<?php } else {?>
														...
														<?php foreach($sidebarPermissionType as $k=>$type){?>
															<label class="mt-checkbox">
																<input type="checkbox" class="backend_menu_permission<?php echo $k;?>" name="<?php echo $abrv;?>lists[]" value="<?php echo $val['mainMenus']['backend_menu_id'],$k;?>" <?php echo strstr($result['backend_menu_permission_lists'], ','.$val['mainMenus']['backend_menu_id'].$k.',') ? 'checked' : '';?>><?php echo $type;?><span></span>
															</label>
														<?php }?>
