												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
		                                                    <label for="news_type_id" class="control-label">分類</label>
	                                                        <select class="form-control select2" id="news_type_id" name="news_type_id">
	                                                        <option value="">請選擇</option>
	                                                        <?php foreach($newsTypeList as $type){?>
	                                                            <option value="<?php echo $type['news_type_id']?>" <?php echo isset($queryData['news_type_id']) && $queryData['news_type_id'] == $type['news_type_id'] ? 'selected' : ''?>><?php echo $type['news_type_name']?></option>
	                                                        <?php }?>
	                                                        </select>
		                                                </div>
													</div>
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<span class="help-block"> 關鍵字：標題、內文</span>
														</div>
													</div>
										...
										<table class="table table-striped table-bordered table-hover" id="sample_1">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $newsTypeList[$val[$abrv.'type_id']][$abrv.'type_name'];?></td>
