										...
										<input type="hidden" id="<?php echo $this->security->get_csrf_token_name()?>" name="<?php echo $this->security->get_csrf_token_name()?>" value="<?php echo $this->security->get_csrf_hash()?>" />
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" placeholder="請填寫標題" class="form-control" id="<?php echo $abrv;?>title" name="<?php echo $abrv;?>title" aria-required="true" value="" />
													</div>
												</div>
												<div class="form-group">
                                                    <label for="news_type_id" class="control-label col-md-3">分類</label>
                                                    <div class="col-md-9">
	                                                    <select class="form-control select2" id="<?php echo $abrv;?>type_id" name="<?php echo $abrv;?>type_id">
	                                                    <?php foreach($newsTypeList as $type){?>
	                                                        <option value="<?php echo $type[$abrv.'type_id']?>"><?php echo $type[$abrv.'type_name']?></option>
	                                                    <?php }?>
	                                                    </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                                                            <input type="text" class="form-control" id="<?php echo $abrv;?>show_date" name="<?php echo $abrv;?>show_date" readonly>
                                                ...
                                                <div class="form-group">
													...
													<div class="col-md-9">
                                                        <textarea class="ckeditor form-control" id="content" name="<?php echo $abrv;?>content" data-error-container="#<?php echo $abrv;?>content" rows="6"></textarea>
