...
<!--<![endif]-->
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
										...
										<form id="formPost" action="" class="formPost form-horizontal form-bordered form-row-stripped" method="post">
											...
											<div class="form-body">
												<div class="form-group">
													<label class="control-label col-md-3">問題</label>
													<div class="col-md-9">
														<input type="text" placeholder="請填寫問題" class="form-control" id="<?php echo $abrv;?>question" name="<?php echo $abrv;?>question" aria-required="true" value="<?php echo isset($result[$abrv.'question']) ? stripslashes($result[$abrv.'question']) : '';?>" />
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">答案</label>
													<div class="col-md-9">
														<textarea placeholder="請填寫答案" rows="5" class="form-control" id="<?php echo $abrv;?>answer" name="<?php echo $abrv;?>answer" aria-required="true"><?php echo isset($result[$abrv.'answer']) ? stripslashes($result[$abrv.'answer']) : '';?></textarea>
													</div>
												</div>
												<div class="form-group">
		...
		<script src="/public/js/main/questions.js" type="text/javascript"></script>
