										...
										<form id="formPost" action="" class="formPost form-horizontal form-bordered form-row-stripped" method="post">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" placeholder="請填寫問題" class="form-control" id="<?php echo $abrv;?>question" name="<?php echo $abrv;?>question" aria-required="true" value="" />
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">答案</label>
													<div class="col-md-9">
														<textarea placeholder="請填寫答案" rows="5" class="form-control" id="<?php echo $abrv;?>answer" name="<?php echo $abrv;?>answer" aria-required="true"></textarea>
													</div>
												</div>
												<div class="form-group">
