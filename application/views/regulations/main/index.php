				...
				<div class="page-content-wrapper">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<a href="/<?php echo $controllerName?>/addMainForm" class="btn blue"><i class="fa fa-plus"></i> 新增 </a>
								</div>
							</div>
						</div>
						<div class="row">
										...
										<table class="table table-striped table-bordered table-hover" id="sample_1">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $val[$abrv.'sort'];?></td>
													<td>
														<a href="/<?php echo $controllerName?>/detail/<?php echo $val[$abrv.'id'];?>" class="btn btn-xs green"> 修改 <i class="fa fa-edit"></i></a>
