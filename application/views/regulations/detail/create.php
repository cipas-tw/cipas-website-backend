										...
										<form id="formPost" action="" class="formPost form-horizontal form-bordered form-row-stripped" method="post">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" placeholder="請填寫標題" class="form-control" id="<?php echo $abrv;?>chapter_title" name="<?php echo $abrv;?>chapter_title" aria-required="true" value="" />
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">排序</label>
													<div class="col-md-9">
														<input type="number" placeholder="請填寫排序" class="form-control" id="<?php echo $abrv;?>chapter_sort" name="<?php echo $abrv;?>chapter_sort" aria-required="true" value="0" />
													</div>
												</div>
												<div class="form-group">
															...
															<thead>
																...
																<tbody id="tbody">
																	<tr id="row_1">
																		...
																		<td>
																			<input type="number" placeholder="排序號碼" class="form-control" id="<?php echo $abrv;?>terms_sort" name="<?php echo $abrv;?>terms_sort[]" aria-required="true" value="1" />
																		</td>
																		<td width="10%">
