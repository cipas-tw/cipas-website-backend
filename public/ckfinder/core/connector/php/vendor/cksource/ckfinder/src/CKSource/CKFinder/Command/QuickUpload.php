...
<script type="text/javascript">
    window.parent.CKEDITOR.tools.callFunction(<?php echo json_encode($funcNum); ?>, <?php echo json_encode(str_replace('/public/cipas-uploads/', 'https://storage.googleapis.com/cipas/', $fileUrl)); ?>, <?php echo json_encode($errorMessage); ?>);
</script>
            <?php
